					  ...
					  <FormGroup row>
					   ...
					   <FormGroup row>
						...
						<Col xs="12" md="9">
						  ...
						  <FormText className="help-block">Please re-enter password</FormText>
						</Col>
					  </FormGroup>   
					  <FormGroup row>
						<Col md="3">
					  ...
					  <FormGroup row>
						  ...
						  <FormGroup check inline>
							 <Dropdown isOpen={this.state.dropdownOpen[0]} toggle={() => {
							  ...
							  <DropdownMenu>
								...
								<DropdownItem>Deliverer</DropdownItem>
								<DropdownItem>Brewiere</DropdownItem>
					   ...
					   <FormGroup row>
						...
						<Col xs="12" md="3">
						  ...
						  <FormText className="help-block">Please enter contact number</FormText>
						</Col>
					  </FormGroup>
					   <FormGroup row>
						<Col md="3">
